...
object P15List {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(f"P15 L Part01: ${P15List(seq321.toList, seq123.toList, _ + _)}")
    println(f"P15 L Part02: ${P15List(seq321.toList, seq123.toList, _ - _)}")
    println(f"P15 L Part03: ${P15List(seq321.toList, seq123.toList, _ * _)}")
    println(f"P15 A Part01: ${P15Array(seq321.toArray, seq123.toArray, _ + _).mkString}")
    println(f"P15 A Part02: ${P15Array(seq321.toArray, seq123.toArray, _ - _).mkString}")
    println(f"P15 A Part03: ${P15Array(seq321.toArray, seq123.toArray, _ * _).mkString}")
  }
